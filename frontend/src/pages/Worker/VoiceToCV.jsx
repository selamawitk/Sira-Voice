...
const VoiceToCV = () => {
  ...
  const handleGenerateCV = async () => {
    ...
    const name = auth?.user?.fullName || 'Worker';
    const skill = editableProfile.skill || 'Not specified';
    const experience = editableProfile.experienceYears || 0;
    const location = editableProfile.location || 'Not specified';
    const text = [
      `=== CV - ${name} ===`,
      '',
      `Name: ${name}`,
